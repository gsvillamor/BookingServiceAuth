...
public class FeedbackController {
	...
	@GetMapping
	public List<Feedback> getFeedback(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId) {
		return reservationRepository.findById(reservationId).get().getFeedbacks();
	}

	@PostMapping
	public List<Feedback> saveFeedback(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId, @RequestBody List<Feedback> feedbacks) {
	...
	@PutMapping
	public List<Feedback> updateFeedback(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId, @RequestBody List<Feedback> feedbacks) {
	...
	@DeleteMapping
	public List<Feedback> deleteFeedback(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId,
