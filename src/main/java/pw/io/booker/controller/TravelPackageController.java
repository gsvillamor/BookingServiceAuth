...
public class TravelPackageController {
	...
	@PostMapping
	public List<TravelPackage> saveAll(@RequestHeader("Authentication-Token") String token,
			@RequestBody List<TravelPackage> travelPackages) {
		return (List<TravelPackage>) travelPackageRepository.saveAll(travelPackages);
	}

	@PutMapping
	public List<TravelPackage> updateAll(@RequestHeader("Authentication-Token") String token,
			@RequestBody List<TravelPackage> travelPackages) {
	...
	public TravelPackage getTravelPackage(@RequestHeader("Authentication-Token") String token,
	...
	public TravelPackage updateTravelPackage(@RequestHeader("Authentication-Token") String token,
	...
	public TravelPackage deleteTravelPackage(@RequestHeader("Authentication-Token") String token,
			@PathVariable("travelPackageId") int travelPackageId) {
