...
public class ReservationController {
	...
	@PostMapping
	public List<Reservation> saveAll(@RequestHeader("Authentication-Token") String token,
	...
	@PutMapping
	public List<Reservation> updateAll(@RequestHeader("Authentication-Token") String token,
			@RequestBody List<Reservation> reservations) {
		for (Reservation reservation : reservations) {
			if (!reservationRepository.findById(reservation.getReservationId()).isPresent()) {
	...
	public Reservation getReservation(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId) {
		return reservationRepository.findById(reservationId).get();
	}

	@PutMapping("/{reservationId}")
	public Reservation updateReservation(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId, @RequestBody Reservation reservation) {
		if (!reservationRepository.findById(reservation.getReservationId()).isPresent()) {
	...
	public Reservation deleteReservation(@RequestHeader("Authentication-Token") String token,
			@PathVariable("reservationId") int reservationId) {
